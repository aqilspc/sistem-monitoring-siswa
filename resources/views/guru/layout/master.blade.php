      ...
      <div class="modal-content">
        ...
        <form enctype="multipart/form-data" method="POST" action="{{url('admin/update/profile')}}">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="name" value="" class="form-control" placeholder="nama kegiatan">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" value="" name="email" class="form-control" placeholder="nama kegiatan">
                                </div>
                            </div>
