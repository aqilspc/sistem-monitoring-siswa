                ...
                <div class="card">
                    ...
                    <div class="body">
                            ...
                            <div class="col-sm-6"><div id="DataTables_Table_0_filter" class="dataTables_filter">
                                ...
                                <div class="col-sm-12"><button class="btn btn-success waves-effect" type="button">+Tambah data kebijakan</button></div>
                                <div class="col-sm-12">
                                ...
                                <thead>
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 90.3333px;" aria-label="NIS: activate to sort column ascending">File Kebijakan</th>
