        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="DataTables_Table_0_length">
                                <label>Show <select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="form-control input-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div></div><div class="col-sm-6"><div id="DataTables_Table_0_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control input-sm" placeholder="" aria-controls="DataTables_Table_0"></label>
                                </div></div></div><div class="row">
                                <div class="col-sm-12"><button class="btn btn-success waves-effect" type="button">+Tambah data kehadiran</button></div>
                                <div class="col-sm-12">
                                ...
                                <thead>
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 90.3333px;" aria-label="Tanggal: activate to sort column ascending">Tanggal</th>
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 90.3333px;" aria-label="Status: activate to sort column ascending">Status</th>
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 83.3333px;" aria-label="Jam: activate to sort column ascending">Jam</th>
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 90.3333px;" aria-label="Action: activate to sort column ascending">Action</th></tr>
                                </thead>
                                <tbody>
                                ...
                                <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <div class="icon" >
                                                <a href="javascript:void(0);"><i class="material-icons" style="color: black">edit</i></a>
                                                <a href="javascript:void(0);"><i class="material-icons" style="color: black">delete</i></a>
                                            </div>
                                        </td>
                                        ...
                                        <td>1</td>
                                        <td><div class="icon">
                                            <a href="javascript:void(0);"><i class="material-icons" style="color: black" >visibility</i></a>
                                            <a href="javascript:void(0);"><i class="material-icons" style="color: black">edit</i></a>
                                            <a href="javascript:void(0);"><i class="material-icons" style="color: black">delete</i></a>
                                        </div></td>
                                    </tr></tbody>
